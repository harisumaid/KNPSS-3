      ...
      <Dimmer.Dimmable blurring dimmed={activeMenu}>
        ...
        <div>
          <div className={styles.firstDiv}>
            <Icon
              link
              name={activeMenu ? "close" : "bars"}
              onClick={menuClick}
              id={styles.topDivMenu}
              size="huge"
            ></Icon>
            <Link href="/">
              <a className={styles.logo}>KNPSS</a>
            </Link>
            <h1 className={styles.title}>
              Kalinganagar Paribesh Surakshya Samiti
            </h1>
            <div className={styles.centerDescriptionContainer}>
              <div className={styles.centerDescription}>
                ...
                <Link href="/about">
                  <Button id={styles.centerButton} size="huge">
                    Learn more
                  </Button>
                </Link>
              </div>
            </div>
            <h1 className={styles.titleBottom}>
              Kalinganagar Paribesh Surakshya Samiti
            </h1>
          ...
          <div className={styles.helpUsDiv}>
            ...
            <Link href='/join-us' >
              <Button color="yellow" id={styles.helpUsDonate} size="huge">
                Join us
              </Button>
            </Link>
          </div>
